...
export default {
  ...
  data() {
    return {
      fontsize: 10,
      content: "中华人民共和国 - The People's Republic of China",
    };
  },
  computed: {
    y() {
    ...
    width() {
      ...
      const width = document.querySelector("#small-font-mock-dom text").getBoundingClientRect()["width"];
